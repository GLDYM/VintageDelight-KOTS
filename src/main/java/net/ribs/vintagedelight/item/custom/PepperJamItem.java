...
public class PepperJamItem extends ConsumableItem {
    public PepperJamItem() {
        super(ModItems.jarItem(ModFoods.PEPPER_JAM), true);
    }
    @Override
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            MasonJarBlock masonJarBlock = (MasonJarBlock) ModBlocks.PEPPER_JAM_JAR.get();
