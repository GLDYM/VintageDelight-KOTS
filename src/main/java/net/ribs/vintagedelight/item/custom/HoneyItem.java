...
public class HoneyItem extends ConsumableItem {
    public HoneyItem() {
        super(ModItems.jarItem(ModFoods.HONEY_JAR), true);
    }
    @Override
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            MasonJarBlock masonJarBlock = (MasonJarBlock) ModBlocks.HONEY_JAR.get();
