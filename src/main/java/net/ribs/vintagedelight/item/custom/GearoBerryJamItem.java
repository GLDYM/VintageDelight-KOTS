...
public class GearoBerryJamItem extends ConsumableItem {
    public GearoBerryJamItem() {
        super(ModItems.jarItem(ModFoods.GEARO_BERRY_JAM), true);
    }
    @Override
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            MasonJarBlock masonJarBlock = (MasonJarBlock) ModBlocks.GEARO_BERRY_JAM_JAR.get();
