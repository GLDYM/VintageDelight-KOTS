...
public class GlowBerryJamItem extends ConsumableItem {
    public GlowBerryJamItem() {
        super(ModItems.jarItem(ModFoods.GLOW_BERRY_JAM), true);
    }
    @Override
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            MasonJarBlock masonJarBlock = (MasonJarBlock) ModBlocks.GLOW_BERRY_JAM_JAR.get();
