...
public class AppleSauceItem extends ConsumableItem {
    public AppleSauceItem() {
        super(ModItems.jarItem(ModFoods.APPLE_SAUCE), true);
    }
    @Override
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            MasonJarBlock masonJarBlock = (MasonJarBlock) ModBlocks.APPLE_SAUCE_JAR.get();
