...
public class RelishItem extends ConsumableItem {
    public RelishItem() {
        super(ModItems.jarItem(ModFoods.RELISH), true);
    }
    @Override
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            MasonJarBlock masonJarBlock = (MasonJarBlock) ModBlocks.RELISH_JAR.get();
