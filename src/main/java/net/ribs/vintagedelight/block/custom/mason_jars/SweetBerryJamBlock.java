...
public class SweetBerryJamBlock extends MasonJarBlock {
    public SweetBerryJamBlock(Properties properties) {
        super(properties);
    }
    @Override
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level world, BlockPos pos, Player player, BlockHitResult hit) {
        if (!world.isClientSide) {
            ...
            if (jars > 1) {
                ...
                popResource(world, pos, new ItemStack(ModItems.SWEET_BERRY_JAM.get()));
